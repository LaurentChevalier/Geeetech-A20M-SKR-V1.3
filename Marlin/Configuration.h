...
#define INVERT_E0_DIR true // BMG Extruder set True, stocl A20M extruder set False
#define INVERT_E1_DIR true // BMG Extruder set True, stocl A20M extruder set False
